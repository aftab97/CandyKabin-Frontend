...
export const PrivacyPolicy = () => {
  return (
    <div className="static-page">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Candy Kabin - PRIVACY POLICY</title>
        <meta
          name="description"
          content="When you visit the Site, we automatically collect certain information about your device, including information about your web browser"
        />
        <meta
          name="keywords"
      ...
      <div className="static-page-title-container">
        <h1>CANDY KABIN PRIVACY POLICY</h1>
      </div>
      <div className="static-page-info-container">
        <br />
        <br />
        <p>
          The below Privacy Policy explains how personal information is
          collected, used, and shared when you visit or make a purchase from
          https://candykabin.co.uk (the “Site”)
        </p>
        <br />
        ...
        <br />
        <p>
          We use a secure order system with one of the leading companies in the
          field, Barclays. Your credit card details are encrypted with Barclays
          on their secure server to protect you from fraud. We do not receive or
          store your credit card details, only the confirmation that the
